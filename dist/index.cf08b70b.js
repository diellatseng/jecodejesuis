(function(window, document, undefined) {
	 ...
	 */ function Skrollr(options) {
        ...
        if (options.easing) for(var e in options.easing)easings[e] = options.easing[e];
        ...
        } else _updateClass(documentElement, [
            SKROLLR_CLASS,
	...
	*/ var _initMobile = function() {
        ...
        _addEvent(documentElement, [
            ...
            while(currentElement.nodeType === 3)currentElement = currentElement.parentNode;
	 ...
	 */ var _calcSteps = function(fakeFrame, actualFrame) {
        ...
        for(; skrollableIndex < skrollablesLength; skrollableIndex++){
            ...
            if (beforeFirst || afterLast) {
                ...
                switch(skrollable.edgeStrategy){
                    ...
                    case 'set':
                        ...
                        for(key in props)if (hasProp.call(props, key)) {
            ...
            var keyFrameIndex = 0;
            for(; keyFrameIndex < framesLength - 1; keyFrameIndex++)if (frame >= frames[keyFrameIndex].frame && frame <= frames[keyFrameIndex + 1].frame) {
                var left = frames[keyFrameIndex];
                var right = frames[keyFrameIndex + 1];
                for(key in left.props)if (hasProp.call(left.props, key)) {
	 ...
	 */ var _parseProps = function(skrollable) {
        ...
        for(; keyFrameIndex < keyFramesLength; keyFrameIndex++){
            ...
            while((match = rxPropValue.exec(frame.props)) !== null){
                ...
                value = value.indexOf('!') ? _parseProp(value) : [
                    value.slice(1)
                ];
	 ...
	 */ var _calcInterpolation = function(val1, val2, progress) {
        ...
        if (val1Length !== val2.length) throw 'Can\'t interpolate between "' + val1[0] + '" and "' + val2[0] + '"';
    ...
    var _removeEvent = skrollr.removeEvent = function(element, names, callback) {
        ...
        var nameCounter = 0;
        var namesLength = names.length;
        for(; nameCounter < namesLength; nameCounter++)if (element.removeEventListener) element.removeEventListener(names[nameCounter], callback, false);
	 ...
	 */ var _getDocumentHeight = function() {
        ...
        var bodyHeight;
        if (_skrollrBody) skrollrBodyHeight = Math.max(_skrollrBody.offsetHeight, _skrollrBody.scrollHeight);
	...
	*/ var _skrollables;
    ...
    else if (typeof module !== 'undefined' && module.exports) module.exports = skrollr;
    else window.skrollr = skrollr;
})(window, document);

//# sourceMappingURL=index.cf08b70b.js.map
